...
<div class="">
    ...
    <div class="flex flex-wrap my-2">
        <div class="w-full md:w-1/3 px-1 my-1">
            <div class="bg-white custom-shadow rounded-lg px-4 py-3 border h-full">
                <div class="flex items-center">
                    <div class="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 flex-shrink-0 font-bold text-lg flex-none">₹</div>
                    <p class="ml-2 text-xs font-bold uppercase tracking-wide text-purple-600">Today's Collection</p>
                </div>
                <p class="text-3xl font-bold text-purple-700 mt-2">₹ {{ number_format($dashboard['todaysCollectionAmount'],2) }}</p>
                <p class="text-xs item-title mt-1">Transactions: {{ $dashboard['todaysCollectionCount'] }}</p>
            </div>
        </div>
        <div class="w-full md:w-1/3 px-1 my-1">
            <div class="bg-white custom-shadow rounded-lg px-4 py-3 border h-full">
                <div class="flex items-center">
                    <div class="w-10 h-10 rounded-full bg-light-orange flex items-center justify-center text-orange-500 flex-shrink-0">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                    </div>
                    <p class="ml-2 text-xs font-bold uppercase tracking-wide text-orange-500">Month Collection</p>
                </div>
                <p class="text-3xl font-bold text-orange-600 mt-2">₹ {{ number_format($dashboard['monthCollectionAmount'],2) }}</p>
                <p class="text-xs item-title mt-1">{{ $dashboard['monthCollectionLabel'] }}</p>
            </div>
        </div>
        <div class="w-full md:w-1/3 px-1 my-1">
            <div class="bg-white custom-shadow rounded-lg px-4 py-3 border h-full">
                <div class="flex items-center">
                    <div class="w-10 h-10 rounded-full bg-light-red flex items-center justify-center text-red-500 flex-shrink-0">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                    </div>
                    <p class="ml-2 text-xs font-bold uppercase tracking-wide text-red-500">Outstanding Fees</p>
                </div>
                <p class="text-3xl font-bold text-red-600 mt-2">₹ {{ number_format($dashboard['outstandingFeesAmount'],2) }}</p>
                <p class="text-xs item-title mt-1">Students: {{ $dashboard['outstandingFeesStudentCount'] }}</p>
            </div>
        </div>
    </div>
    @endif
    ...
    <div class="flex flex-wrap my-2">
        <div class="w-full xl:w-1/3 lg:w-2/3 my-2">
            <div class="flex flex-wrap lg:flex-row">
                ...
                <div class="w-full lg:w-1/2 md:w-1/2 px-1 my-1">
                    <div class="bg-white custom-shadow rounded-lg px-4 py-3 border h-full">
                        <div class="flex items-center">
                            <div class="w-10 h-10 rounded-full bg-light-green flex items-center justify-center text-green-500 flex-shrink-0">
                                <svg class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
                                    <g id="Outline">
                            ...
                            <p class="ml-2 text-xs font-bold uppercase tracking-wide text-green-500">Total Staff</p>
                        </div>
                        <p class="text-3xl font-bold text-green-600 mt-2">{{ $dashboard['teacherCount'] + $dashboard['nonteachingCount'] }}</p>
                        <p class="text-xs item-title mt-1">Teaching: {{ $dashboard['teacherCount'] }} | Non-Teaching: {{ $dashboard['nonteachingCount'] }}</p>
                    </div>
                </div>
                <div class="w-full lg:w-1/2 md:w-1/2 px-1 my-1">
                    <a href="{{ url('/admin/parents') }}">
                        <div class="bg-white custom-shadow px-3 py-3 border">
                            <div class="w-20 h-20 rounded-full bg-light-orange flex items-center justify-center mx-auto text-orange-500">
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve
                                        </g>
                                    </g>
                                    <g>
                                        <g>
                                            <path d="M274.911,282.7c-3.906-3.904-10.236-3.904-14.143,0c-2.629,2.631-6.908,2.631-9.537,0c-3.906-3.904-10.236-3.904-14.143,0 c-3.905,3.905-3.905,10.237,0,14.143c5.215,5.214,12.063,7.82,18.912,7.82s13.697-2.606,18.911-7.82 C278.816,292.938,278.816,286.606,274.911,282.7z"></path>
                                        </g>
                                    </g>
                                    <g></g>
                                    <g></g>
        ...
        <div class="w-full lg:w-1/3 px-1 my-3">
            <div class="bg-white custom-shadow rounded-lg px-4 py-3 border mb-2">
                <div class="flex items-center">
                    <div class="w-10 h-10 rounded-full bg-light-blue flex items-center justify-center text-blue-500 flex-shrink-0">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    ...
                    <p class="ml-2 text-xs font-bold uppercase tracking-wide text-blue-500">Student Attendance Today</p>
                </div>
                <div class="flex items-center justify-around mt-3">
                    <div class="text-center">
                        <p class="text-xs item-title">Present</p>
                        <p class="text-2xl font-bold text-green-600">{{ $dashboard['studentPresentToday'] }}</p>
                    </div>
                    <div class="text-center">
                        <p class="text-xs item-title">Absent</p>
                        <p class="text-2xl font-bold text-red-600">{{ $dashboard['studentAbsentToday'] }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white custom-shadow rounded-lg px-4 py-3 border">
                <div class="flex items-center">
                    <div class="w-10 h-10 rounded-full bg-light-blue flex items-center justify-center text-blue-500 flex-shrink-0">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    ...
                    <p class="ml-2 text-xs font-bold uppercase tracking-wide text-blue-500">Staff Attendance Today</p>
                </div>
                <div class="mt-3">
                    <div class="flex items-center justify-end mb-1">
                        <span class="text-xs item-title w-14 text-center">Present</span>
                        <span class="text-xs item-title w-14 text-center">Absent</span>
                    </div>
                    <div class="flex items-center justify-between border-b pb-2 mb-2">
                        <p class="text-xs item-title font-semibold">Teaching</p>
                        <div class="flex items-center">
                            <span class="text-lg font-bold text-green-600 w-14 text-center">{{ $dashboard['teachingStaffPresentToday'] }}</span>
                            <span class="text-lg font-bold text-red-600 w-14 text-center">{{ $dashboard['teachingStaffAbsentToday'] }}</span>
                        </div>
                    </div>
                    <div class="flex items-center justify-between">
                        <p class="text-xs item-title font-semibold">Non-Teaching</p>
                        <div class="flex items-center">
                            <span class="text-lg font-bold text-green-600 w-14 text-center">{{ $dashboard['nonTeachingStaffPresentToday'] }}</span>
                            <span class="text-lg font-bold text-red-600 w-14 text-center">{{ $dashboard['nonTeachingStaffAbsentToday'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="text-sm my-1">
                            ...
                            <div class="flex justify-end">
                                <a href="{{ $noticeboard->AttachmentPath }}" target="_blank">
                                    <svg class="w-5 h-5 fill-current mr-1 text-gray-600" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                        <g>
                                            <g>
    ...
    <!-- classwise student strength + fee collection summary -->
    <div class="flex flex-wrap my-2">
        <div class="w-full @if(config('gfee.enabled', false)) lg:w-1/2 @endif px-1 my-2">
            <div class="bg-white custom-shadow px-4 py-3 border h-full">
                <div>
                    <h1 class="text-gray-800 font-semibold text-xl">Class Wise Student Strength</h1>
                </div>
                <div class="mt-3" style="height: 250px;">
                    <canvas id="classStrengthChart" data-chart="{{ json_encode($dashboard['classWiseStrength']) }}"></canvas>
                </div>
            </div>
        </div>
        @if(config('gfee.enabled', false))
        <div class="w-full lg:w-1/2 px-1 my-2">
            <div class="bg-white custom-shadow px-4 py-3 border h-full">
                <div>
                    <h1 class="text-gray-800 font-semibold text-xl">Fee Collection Summary ({{ $dashboard['monthCollectionLabel'] }})</h1>
                </div>
                <div class="mt-3 flex flex-wrap items-center">
                    <div class="w-full md:w-1/2" style="height: 220px;">
                        <canvas id="feeCollectionChart" data-chart="{{ json_encode($dashboard['feeCollectionSummary']) }}"></canvas>
                    </div>
                    <div class="w-full md:w-1/2 mt-3 md:mt-0">
                        <ul id="feeCollectionLegend" class="text-sm"></ul>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <td>
                                <div class="flex items-center">
                                    <a href="{{ url('admin/feedback/edit/'.$feedback->id) }}" title="Show">
                                        <svg class="w-4 h-4 fill-current text-gray-500 mx-1" height="512pt" viewBox="-27 0 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg">
...
<script>
    var classStrengthEl = document.getElementById('classStrengthChart');
    if (classStrengthEl) {
        var classWiseStrength = JSON.parse(classStrengthEl.dataset.chart);
        var classLabels = classWiseStrength.map(function(item) {
            return item.label;
        });
        var classCounts = classWiseStrength.map(function(item) {
            return item.count;
        });

        var classStrengthChart = new Chart(classStrengthEl.getContext('2d'), {
            type: 'bar',
            data: {
                labels: classLabels,
                datasets: [{
                ...
                afterDatasetsDraw: function(chart) {
                    ...
                    chart.data.datasets.forEach(function(dataset, i) {
                        ...
                        meta.data.forEach(function(bar, index) {
                            ...
                            ctx.fillText(value, bar._model.x, bar._model.y - 4);
                        });
                    });
                }
            }]
    ...
    var feeChartEl = document.getElementById('feeCollectionChart');
    if (feeChartEl) {
        var feeCollectionSummary = JSON.parse(feeChartEl.dataset.chart);
        var feeLabels = feeCollectionSummary.map(function(item) {
            return item.label;
        });
        var feeAmounts = feeCollectionSummary.map(function(item) {
            return item.amount;
        });
        var feeColors = ['#304ffe', '#10b981', '#f59e0b', '#8b5cf6', '#14b8a6', '#ef4444', '#ec4899'];

        var feeCollectionChart = new Chart(feeChartEl.getContext('2d'), {
            type: 'doughnut',
            data: {
                labels: feeLabels,
                datasets: [{
        ...
        var legendHtml = '';
        feeLabels.forEach(function(label, i) {
            legendHtml += '<li class="flex items-center justify-between py-1">' +
                '<span class="flex items-center"><span class="w-3 h-3 rounded-full inline-block mr-2" style="background-color:' + feeColors[i % feeColors.length] + '"></span>' + label + '</span>' +
                '<span class="font-semibold ml-2">₹ ' + Number(feeAmounts[i]).toLocaleString('en-IN') + '</span>' +
                '</li>';
        });
        document.getElementById('feeCollectionLegend').innerHTML = legendHtml;
    }
